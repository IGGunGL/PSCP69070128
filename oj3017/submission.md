...
```text
Input: ราคาสินค้า (เลขทศนิยม)

Output: ยอดรวมสุทธิ ทศนิยม 2 ตำแหน่ง

มีการคิด vat หลังสุด ถ้าคิดก่อนอาจจะให้ผิดได้
```
...
```text
Step 1: อ่านราคาสินค้า (price)
Step 2: คำนวณค่าบริการ = price * 10%
Step 3: เช็คว่าค่าบริการเกิน 1000 หรือไม่ ถ้าเกิน ปรับเป็น 1000
Step 4: เช็คว่าค่าบริการน้อยกว่า 50 หรือไม่ ถ้าน้อยกว่า ปรับเป็น 50
Step 5: รวมราคาสินค้ากับค่าบริการ
Step 6: คูณผลรวมด้วย VAT 7%
Step 7: พิมพ์ผลลัพธ์ทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายที่ใช้จริงคือคำนวณค่าบริการเป็น 10% ของราคาสินค้าก่อน จากนั้นเช็คทีละเงื่อนไข 
ถ้าค่าบริการเกิน 1000 ก็ตัดเหลือ 1000 ถ้าเท่ากับ 0 พอดีก็ปล่อยไว้ที่ 0 และถ้าน้อยกว่า 50 
(แต่ไม่ใช่ 0) ก็ดันขึ้นเป็น 50 แล้วค่อยเอาราคาสินค้ากับค่าบริการมารวมกัน คูณ VAT 7% แล้วพิมพ์ผล

วิธีนี้เหมือนที่วางแผนไว้ตั้งแต่แรก เพราะตอนคิดแรกก็คิดแบบนี้อยู่แล้ว 
คือคำนวณค่าบริการก่อน แล้วค่อยไล่เช็คเพดานบนกับเพดานล่างทีหลัง ไม่ได้เปลี่ยนวิธีคิดระหว่างเขียนโค้ด
```
...
```text
ราคาปกติ ค่าบริการ 10% (500) ไม่เกิน 1000 และไม่ต่ำกว่า 50 เลยไม่โดนปรับ
```
...
```text
ราคาสูงจนค่าบริการ 10% (1500) เกิน 1000 เช็คว่าเงื่อนไขเพดานบนทำงานถูก
```
...
```text
ราคาต่ำจนค่าบริการ 10% (10) น้อยกว่า 50 เช็คว่าเงื่อนไขเพดานล่างทำงานถูก
```
