...
```text
input : คำ 1 คำ
output : นับสระจากข้อความที่ให้มา โดยเป็น case not sensitive และแสดงสระที่นับได้
```
...
```text
Step 1: อ่านข้อความเข้ามา แล้วแปลงตัวอักษรทั้งหมดให้เป็น ตัวพิมพ์เล็ก ด้วย .lower()
Step 2: สร้างรายการสระภาษาอังกฤษ vowels = ['a', 'e', 'i', 'o', 'u']
Step 3: วนลูปหยิบสระทีละตัว i จากรายการ vowels
Step 4: นับจำนวนครั้งที่สระ i ปรากฏอยู่ในข้อความด้วยคำสั่ง text.count(i) แล้วเก็บใส่ตัวแปร count
Step 5: ถ้าจริง ให้พิมพ์สระและจำนวนออกมาในรูปแบบ i : count
```
...
```text
คล้ายๆเดิมแต่มีแก้ testcase ที่เป็น 0 เพราะ testcase ไม่นับตัวที่ 0 ด้วย
```
...
```text
กรณีข้อความทั่วไป มีทั้งตัวพิมพ์เล็ก-ใหญ่และตัวพิเศษ
```
...
```text
กรณีสระซ้ำตัวพิมพ์ใหญ่ทั้งหมดมีสระครบทุกตัว
```
...
```text
กรณีไม่มีสระเลย หรือมีแต่ตัวเลข/พยัญชนะ
```
