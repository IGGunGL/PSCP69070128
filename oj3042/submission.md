...
constraints = จำนวนเต็มบวกจนถึง 0 เท่านั้น
```
...
```text
Step 1: รับค่าตัวเลข
Step 2: เอาเข้า absolute กันติดลบ
Step 3: จากนั้นเอาเข้าสูตร // 10) * 10 เพื่อตัดพวกเศษ
Step 4: จากนั้น print 
```
...
```text
คล้ายๆเดิมแต่ปริ้นแล้วใส่สูตรใน range print ออกมาเลยจะได้เขียนเข้าใจง่ายๆ
```
