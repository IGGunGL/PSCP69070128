...
```text
input = รับค่า ความเร็วหมึก กับจำนวนบ้าน และ พิกัดบ้าน
output = วินาทีที่บ้านจะโดนน้ำหมึกท่วม
constraints = ใช้สูตรทางคณิตพื้นที่วงกลม และ สูตรฟิสิกส์ในการหา
```
...
```text
Step 1: รับค่า ink กับ บ้านก่อน
Step 2: รับค่าพิกัดบ้านใน for i 
Step 3: เอามาใส่เข้าสูตรหาพื้นที่ของบ้านนั้น
Step 4: เอามาใส่สูตรเพื่อหาเวลา
```
...
```text
เหมือนกับแผนแรกแต่มีการใช้ math ceil เพิ่มเนื่องจากโจทย์บอกให้ถ้าเวลาไม่พอดีให้ตัดเป็นวินาทีต่อไป
```
...
```text
เช็กตรรกะคำนวณและปัดเศษทศนิยมขึ้น
```
...
```text
เช็กว่าวนลูปคำนวณบ้านหลายหลังและเลขค่ามากได้ถูกต้อง
```
...
```text
คอยบอกวิธีการใช้แต่ละคำสั่ง เช่น พวก math ceil
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนแผน เขียน code ทดสอบ และส่ง OJ ด้วยตนเองทั้งหมด
```
