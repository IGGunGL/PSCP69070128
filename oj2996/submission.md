...
```text
โจทย์นี้ห้เขียนโปรแกรม กลับด้านตัวอักษร แล้วแปลงเป็นตัวเล็กทั้งหมด

Input: ข้อความอังกฤษยาว 5 ตัว

Output: ข้อความตัวเดิมแต่กลับจากหลังมาหน้า แล้วทำเป็นตัวพิมพ์เล็กทั้งหมด

โจทย์บอกว่ายาว 5 ตัวอักษร แต่ก็ยังต้องคิดว่าจะทำยังไงกับตัวพิมพ์ใหญ่-เล็กปนกันใน input ยังไง เพราะสุดท้ายต้องบังคับให้เป็นพิมพ์เล็กหมดอยู่ดี
```
...
```text
Step 1: รับ input ข้อความจากผู้ใช้
Step 2: แปลงข้อความทั้งหมดเป็นตัวพิมพ์เล็ก
Step 3: กลับด้านข้อความจากหลังไปหน้า
Step 4: Print ผลลัพธ์
```
...
```text
เหมือนกับแผนแรกเพราะโจทย์ไม่ได้ซับซ้อนอะไร ไม่มีจุดที่ต้องปรับระหว่างเขียนโค้ด
```
...
```text
เช็คว่าโปรแกรม lower() ทำงานถูกต้องมั้ย
```
...
```text
เช็คกรณีว่า lower() แปลงได้ครบทุกตัวมั้ย
```
...
```text
เช็คว่า reverse ทำงานถูกต้องมั้ย
```
...
```text
ชวนบอกวิธีการใช้ .lower
```

คุณยังทำอะไรด้วยตนเอง

```text
คิดทำทุกอย่างแค่ถามวิธีการใช้
```
