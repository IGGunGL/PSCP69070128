...
```text
Input: อุณหภูมิ (ตัวเลข), หน่วยต้นทาง, หน่วยปลายทาง

Output: ค่าอุณหภูมิใหม่ (ทศนิยม 2 ตำแหน่ง)

Constraint: รองรับเฉพาะ C K F R
```
...
```text
Step 1: อ่านอุณหภูมิ degree (float) และรับหน่วยต้นทาง O กับหน่วยปลายทาง N โดยปรับเป็นตัวพิมพ์ใหญ่
Step 2: แปลงค่า degree จากหน่วยต้นทาง O ให้เป็นองศา Celsius
Step 3: แปลงค่า Celsius ไปเป็นอุณหภูมิในหน่วยปลายทาง N
Step 4: พิมพ์ผลลัพธ์เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เหมือนแผนแรกแต่เช็คพวก testcase นิดหน่อยเพราะโจทย์ไม่ค่อยซับซ้อนแค่ใช้สูตรทางวิทยาศาสตร์เยอะ
```
...
```text
เช็กตัวพิมพ์เล็กและแปลงหน่วยเดิม
```
