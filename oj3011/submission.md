...
```text
Input: พิมพ์ชื่อสีเข้าไป 2 บรรทัด
Output: สีที่ได้จากการผสม
จุดที่ต้องระวัง : โค้ดเช็คตัวอักษรแบบตรงเป๊ะ ต้องพิมพ์ตัวใหญ่ตัวแรกเท่านั้น ไม่งั้นจะ Error
```
...
```text
1. อ่านค่า Color1 และ Color2 จากผู้ใช้
2. เช็คทีละคู่สีที่ผสมกันได้ (Red-Blue, Red-Yellow, Blue-Yellow) ไม่สนลำดับ 
   ถ้าตรงคู่ไหน พิมพ์สีผสมที่ได้ (Violet, Orange, Green ตามลำดับ)
3. ถ้าสีทั้งสองเหมือนกัน (Red-Red, Blue-Blue, Yellow-Yellow) พิมพ์สีเดิมนั้น
4. ถ้า Color1 เป็นสีที่รู้จัก (Red/Blue/Yellow) แต่ Color2 ไม่ตรงกับสีที่ผสมได้เลย 
   ให้พิมพ์ Error เช็คแยกตามแต่ละสีของ Color1
5. ถ้าไม่เข้าเงื่อนไขไหนเลย (เช่น Color1 เองก็ไม่ใช่สีที่รู้จัก) ให้พิมพ์ Error
```
...
```text
วิธีนี้เหมือนกับแผนแรกที่วางไว้ เพราะตั้งแต่ต้นฉันตั้งใจจะแยกกรณี Error ตามสีแรกอยู่แล้ว 
ไม่ได้ปรับเปลี่ยนระหว่างเขียนโค้ดจริง
```
...
```text
เช็คกรณีปกติที่ผสม 2 สีต่างกัน
```
...
```text
เช็คกรณี Error เมื่อ Color2 ไม่ตรงกับสีที่ผสมได้
```
